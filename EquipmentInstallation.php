...
<header>	
				...
				<!--<div class="col-lg-6 foot-1_grid_right">-->
					...
					<!--<div class="contact_grid_right mt-5 mx-auto text-left">-->
						<!--<div class="col-md-4 about-info about-info1">-->
								...
								<p>Equipment Installation with expert support </p>
								<!--Resource https://www.engineering.com/DesignerEdge/DesignerEdgeArticles/ArticleID/16653/Smart-FarmingAutomated-and-Connected-Agriculture.aspx-->
								<p>Replacing human labor with automation is a growing trend across multiple industries, and agriculture is no exception. Most aspects of farming are exceptionally labor-intensive, with much of that labor comprised of repetitive and standardized tasks—an ideal niche for robotics and automation.</p>
						<!--</div>-->
			        <!--</div>-->
			    <!--</div>-->
	</section>
   <section class="foot-1 py-5" id="UserForm">
               	<div class="col-md-4 newsgrid1">
                	<p><h4 class="mb-4">Smart device installation</h4></p>
                    <p>1 This service will enable smart farm building with eperts suppport  </p>

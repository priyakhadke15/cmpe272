...
<header>	
				...
				<!--<div class="col-lg-6 foot-1_grid_right">-->
					...
					<!--<div class="contact_grid_right mt-5 mx-auto text-left">-->
						<!--<div class="col-md-4 about-info about-info1">-->
								...
								<h4>Real Time Monitoring</a></h4>
							<p>Multiple ranches can be monitored by farmers at real time.This helps farmers know the soil health, climate conditions temperature and crop health.</p>
							<p>Get real time feed for your all your farms .Access daily feeds on your desktop or phone. Interactive dashboards will fetch sensors data across all the farms</p>
						<!--</div>-->
			        <!--</div>-->
			    <!--</div>-->
	</section>
   <section class="foot-1 py-5" id="UserForm">
               	<div class="col-md-4 newsgrid1">
                	<p><h4 class="mb-4">Remotely Monitor your Farm</h4></p>
                    <p>The dashboard shows the farm status for all the ranches</p>
                    <p>Agriculture sensors are constantly monitoring the farm health</p>
                    <p>Keep track of threshold crossing</p>
                </div>
 </section>
</html>
